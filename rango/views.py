...
def index(request):
	...
	return HttpResponse('Rango says hey there partner! <a href="' + about_absolute_url + '">About</a>.')

def about(request):
	index_relative_url = reverse('rango:index')
	index_absolute_url = request.build_absolute_uri(index_relative_url)
	return HttpResponse('Rango says here is the about page. <a href="' + index_absolute_url + '">Index</a>.')