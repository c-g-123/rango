...
def index(request):
	...
	return HttpResponse('Rango says hey there partner! About page: ' + about_absolute_url + '.')

def about(request):
	index_relative_url = reverse('rango:index')
	index_absolute_url = request.build_absolute_uri(index_relative_url)
	return HttpResponse('Rango says here is the about page. Index page: ' + index_absolute_url + '.')